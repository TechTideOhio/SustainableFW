...
export function FooterSection() {
  return (
    <footer className="pt-24 pb-8 px-4 sm:px-6 lg:px-8">
      <div className="bg-lime rounded-[3rem] pt-12 md:pt-16 pb-12 px-4 sm:px-6 lg:px-8 relative shadow-2xl">
        <div className="max-w-7xl mx-auto">
          
          {/* CTA Card seamlessly integrated into the top of the footer container */}
          <div className="max-w-5xl mx-auto bg-zinc-900/95 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl mb-24 text-white">
