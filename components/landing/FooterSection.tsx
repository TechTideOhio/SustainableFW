...
export function FooterSection() {
  return (
    <footer className="pt-24 pb-8 px-4 sm:px-6 lg:px-8">
      <div className="bg-brand-600 rounded-[3rem] pt-12 md:pt-16 pb-12 px-4 sm:px-6 lg:px-8 relative shadow-2xl">
        <div className="max-w-7xl mx-auto">
          
          {/* CTA Card seamlessly integrated into the top of the footer container */}
          <div className="max-w-5xl mx-auto bg-slate-900 backdrop-blur-xl border border-slate-700 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl mb-24 text-white">
            ...
            <div className="w-full md:w-auto flex flex-col sm:flex-row gap-3">
              <Input 
                ...
                className="bg-slate-800 border-slate-600 text-white h-12 w-full sm:w-64 rounded-xl focus-visible:ring-white"
                aria-label="Email address"
              />
              <Button className="bg-white text-brand-600 hover:bg-slate-100 rounded-xl h-12 px-6 font-semibold flex items-center gap-2">
                Start Free Trial
              ...
              <div className="col-span-1 md:col-span-3 grid grid-cols-2 sm:grid-cols-3 gap-8">
                ...
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <div className="flex gap-4">
                    <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors" aria-label="MessageCircle">
                      <MessageCircle className="w-5 h-5" />
                    </a>
                    <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors" aria-label="Code">
                      <Code className="w-5 h-5" />
                    </a>
                    <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors" aria-label="Link">
